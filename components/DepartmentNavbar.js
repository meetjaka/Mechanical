                ...
                {item.hasDropdown && (
                  <div
                    className={`absolute top-full ${
                      idx === navItems.length - 1 ? "right-0" : "left-0"
                    } mt-2 w-96 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform group-hover:translate-y-0 translate-y-2`}
                  >
                    <div className="p-4">
                        ...
                        <div key={dropdownItem.name}>
                          {dropdownItem.isExternal ? (
                            ...
                            >
                              ...
                              <ChevronDown
                                className={`w-4 h-4 transition-colors rotate-[-90deg] mt-1 ${
                                  isActive(dropdownItem.href)
                                    ? "text-[#0066A1]"
                            ...
                            <div className="group/item flex items-start gap-3 px-4 py-3 text-sm rounded-xl cursor-default">
                              ...
                              <ChevronDown
                                className={`w-4 h-4 text-gray-400 rotate-[-90deg] mt-1`}
                              />
                            </div>
                          )}
                        </div>
                      ...
                      {item.dropdownItems.map((dropdownItem) => (
                        <div key={dropdownItem.name}>
                          {dropdownItem.isExternal ? (
                            ...
                            <div className="flex items-center gap-2 px-4 py-3 text-sm rounded-lg font-medium text-gray-700">
                              {dropdownItem.icon && (
                                <dropdownItem.icon className="w-4 h-4" />
                              )}
                              {dropdownItem.name}
