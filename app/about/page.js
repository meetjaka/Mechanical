...
export default function AboutPage() {
  const stats = [
    ...
    { value: "100%", label: "Placement: 2025-26" },
  ];
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Showcasing our commitment to excellence in education, research,
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto text-base md:text-lg">
                The Department of Mechanical Engineering offers comprehensive
                programs across undergraduate, postgraduate, and doctoral levels
              </p>
            </div>
              ...
              <div className="lg:col-span-2 group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border-2 border-[#0066A1] transform hover:-translate-y-1">
                ...
                <div className="p-8 md:p-10">
                  ...
                  <p className="text-gray-700 text-sm md:text-base leading-relaxed mb-8">
                    Comprehensive 4-year undergraduate program designed to build
                    strong fundamentals in mechanical engineering with hands-on
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-6 border-t-2 border-gray-100">
                    <div className="text-center">
                      <div className="text-3xl font-bold text-[#004D83] mb-1">
                        4
                      </div>
                ...
                <div className="p-8 md:p-10">
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 font-medium">
                        Choose your specialization path from 7 cutting-edge
                        domains
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {btechMinors.map((minor, idx) => (
                      <div
                        key={idx}
                        className="group/item bg-white rounded-xl p-4 shadow-sm border-2 border-gray-200 hover:border-orange-500 hover:shadow-md transition-all duration-300"
                      >
        ...
        <div className="py-16 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#004D83] mb-3">
                Ph.D.:{" "}
                <span className="text-[#0066A1]">Mechanical Engineering</span>
              </h2>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Discover the opportunities and research excellence in our
                doctoral program
              </p>
            </div>
            <div className="max-w-5xl mx-auto">
              <div
                className="relative w-full rounded-2xl overflow-hidden shadow-2xl border-4 border-white ring-1 ring-gray-200"
